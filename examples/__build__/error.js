...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _src_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../src/index */ \"../src/index.ts\");\n\nObject(_src_index__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n    method: 'get',\n    url: '/error/get1'\n}).then(function (res) {\n    console.log(res);\n}).catch(function (e) {\n    console.log(e);\n});\nObject(_src_index__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n    method: 'get',\n    url: '/error/get'\n}).then(function (res) {\n    console.log(res);\n}).catch(function (e) {\n    console.log(e);\n});\nsetTimeout(function () {\n    Object(_src_index__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n        method: 'get',\n        url: '/error/get'\n    }).then(function (res) {\n        console.log(res);\n    }).catch(function (e) {\n        console.log(e);\n    });\n}, 5000);\nObject(_src_index__WEBPACK_IMPORTED_MODULE_0__[\"default\"])({\n    method: 'get',\n    url: '/error/timeout',\n    timeout: 2000\n}).then(function (res) {\n    console.log(res);\n}).catch(function (e) {\n    console.log(e.message);\n    console.log(e.config);\n    console.log(e.code);\n    console.log(e.request);\n    console.log(e.isAxiosError);\n});\n\n\n//# sourceURL=webpack:///./error/app.ts?");

/***/ }),

/***/ 1:
/*!**********************************************************!*\
  !*** multi webpack-hot-middleware/client ./error/app.ts ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! webpack-hot-middleware/client */\"../node_modules/webpack-hot-middleware/client.js\");\nmodule.exports = __webpack_require__(/*! /Users/sadhu/Desktop/ts-axios/examples/error/app.ts */\"./error/app.ts\");\n\n\n//# sourceURL=webpack:///multi_webpack-hot-middleware/client_./error/app.ts?");
